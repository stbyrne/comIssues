...
.controller('IssuesListCtrl', function ($scope, $http, $ionicModal, $ionicSlideBoxDelegate, $timeout, $ionicLoading, issuesThinkCentral, issuesHmof, processDescriptions) {
        ...
        // Using the data returned from the issuesThinkCentral factory
        ...
        // Handle the Issue title where there is more than one cause

        $scope.setIssue = function (issue) {

            console.log("This is the current issue text: " + issue);

            $scope.$parent.issue = issue;

        }
        $scope.getIssue = function () {
            return $scope.$parent.issue;
        }
